                ...
                var x = function () {
                    ...
                    function r() {
                        function t(t) {
                            ...
                            if ("scroll" === T) {
                                ...
                                for (var E in a(r).tweensContainer && !0 === a(r).isAnimating && (O = a(r).tweensContainer), u.each(y, function (t, e) {
                                    ...
                                    if (a(r).isSVG || "tween" === z || !1 !== b.Names.prefixCheck(z)[1] || b.Normalizations.registered[z] !== n) {
                                        (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(E) && !V && 0 !== F && (V = 0), c._cacheValues && O && O[E] ? (V === n && (V = O[E].endValue + O[E].unitType), N = a(r).rootPropertyValueCache[z]) : b.Hooks.registered[E] ? V === n ? (N = b.getPropertyValue(r, z), V = b.getPropertyValue(r, E, N)) : N = b.Hooks.templates[z][1] : V === n && (V = b.getPropertyValue(r, E));
                                        var H, j, B, Y = !1;
                                        if (V = (H = f(E, V))[0], B = H[1], F = (H = f(E, F))[0].replace(/^([+-\/*])=/, function (t, e) {
                                                return Y = e, ""
                                            }), j = H[1], V = parseFloat(V) || 0, F = parseFloat(F) || 0, "%" === j && (/^(fontSize|lineHeight)$/.test(E) ? (F /= 100, j = "em") : /^scale/.test(E) ? (F /= 100, j = "") : /(Red|Green|Blue)$/i.test(E) && (F = F / 100 * 255, j = "")), /[\/*]/.test(Y)) j = B;
                                        else if (B !== j && 0 !== V)
                                            if (0 === F) j = B;
                                            else {
                                                o = o || m();
                            ...
                            d.element && (b.Values.addClass(r, "velocity-animating"), R.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, S === C - 1 ? (v.State.calls.push([R, g, c, null, P.resolver]), !1 === v.State.isTicking && (v.State.isTicking = !0, l())) : S++)
                        }
                        var o, r = this,
                    ...
                    if (p.isWrapped(this) ? (d = !1, f = 0, g = this, h = this) : (d = !0, f = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
                                ...
                                if (!u.isPlainObject(y) || p.isEmptyObject(y)) {
                                    if (p.isString(y) && v.Redirects[y]) {
                                        ...
                                        return !0 === E.backwards && (g = u.extend(!0, [], g).reverse()), u.each(g, function (t, e) {
                                            parseFloat(E.stagger) ? E.delay = O + parseFloat(E.stagger) * t : p.isFunction(E.stagger) && (E.delay = O + E.stagger.call(e, t, C)), E.drag && (E.duration = parseFloat(A) || (/^(callout|transition)/.test(y) ? 1e3 : m), E.duration = Math.max(E.duration * (E.backwards ? 1 - t / C : (t + 1) / C), .75 * E.duration, 200)), v.Redirects[y].call(e, e, E || {}, t, C, g, P.promise ? P : n)
                                        }), t()
                                    }
                        ...
                        if (u.each(g, function (t, e) {
                            ...
                            for (var $ = 0; D > $; $++) {
                                ...
                                $ === D - 1 && (F.display = E.display, F.visibility = E.visibility, F.complete = E.complete), x(g, "reverse", F)
                            }
                        return t()
                    }
                };
                ...
                e.exports = {
                    ...
                    update: function (t, e, i) {
                        if (t) {
                            ...
                            var F = l + E,
                                W = u + L;
                            n.each(h.concat(f), z), F += k, W += C, n.each(p, z), n.each(m, z), t.chartArea = {
                                left: A,
                                top: _,
                                right: A + k,
                                bottom: _ + C
                        ...
                        function z(t) {
                            t.isHorizontal() ? (t.left = t.fullWidth ? l : A, t.right = t.fullWidth ? e - c : A + k, t.top = W, t.bottom = W + t.height, W = t.bottom) : (t.left = F, t.right = F + t.width, t.top = _, t.bottom = _ + C, F = t.right)
                        }
                    }
                }
            }, {
                        ...
                        if (i.display) {
                            ...
                            if (a.each(g, function (n, o) {
                                    if (!a.isNullOrUndef(n.label)) {
                                        var c, u, d, p, v, y, b, x, k, C, S, D, E, L, R = n.label;
                                        ...
                                        if (m) {
                                            var V = w + W;
                                            "bottom" === i.position ? (F = f ? "middle" : "top", $ = f ? "right" : "center", L = e.top + V) : (F = f ? "middle" : "bottom", $ = f ? "left" : "center", L = e.bottom - V);
                                            var z = l(e, o, h.offsetGridLines && g.length > 1);
                                            z < e.left && (u = "rgba(0,0,0,0)"), z += a.aliasPixel(c), E = e.getPixelForTick(o) + s.labelOffset, v = b = k = S = z, y = O, x = _, C = t.top, D = t.bottom + P
                                        } else {
                                            var N, H = "left" === i.position;
                                            s.mirror ? ($ = H ? "left" : "right", N = W) : ($ = H ? "right" : "left", N = w + W), E = H ? e.right - N : e.left + N;
                                ...
                                var D, E, L = 0,
                                    R = d(p) / 2;
                                if (m) D = e.left + (e.right - e.left) / 2, E = "bottom" === i.position ? e.bottom - R - S.bottom : e.top + R + S.top;
                                else {
                                    var $ = "left" === i.position;
                                    D = $ ? e.left + R + S.top : e.right - R - S.top, E = e.top + (e.bottom - e.top) / 2, L = $ ? -.5 * Math.PI : .5 * Math.PI
                                }
                            ...
                            if (h.drawBorder) {
                                ...
                                m ? (V = z = "top" === i.position ? e.bottom : e.top, V += N, z += N) : (F = W = "left" === i.position ? e.right : e.left, F += N, W += N), o.beginPath(), o.moveTo(F, V), o.lineTo(W, z), o.stroke()
                            }
                        }
                    }
                })
...
dropdownSelectors.on({
                ...
                return _createClass(d, [{
                    ...
                    value: function (t) {
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            this.disableScrolling(), 0 !== this.$sidenavOverlay.length || this.buildSidenavOverlay(), "left" === this.options.edge && (e > this.options.menuWidth ? e = this.options.menuWidth : e < 0 && (e = 0)), this.translateSidenavX(e), this.updateOverlayOpacity(e)
                        }
                    }
                }, {
                    ...
                    value: function (t) {
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            n > 0 && (n = 0), o < 0 && (o = 0), "left" === this.options.edge ? (this.menuOut && e <= .3 || e < -.5 ? (0 !== n && this.translateMenuX([0, n], "300"), this.showSidenavOverlay()) : (!this.menuOut || e > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.menuWidth - 10, n], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                                width: "10px",
                                right: "",
                                left: 0
                                ...
                                right: "",
                                left: 0
                            })) : (!this.menuOut || e < -.3) && (this.enableScrolling(), this.translateMenuX([this.options.menuWidth + 10, o], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({
                                width: "10px",
                                right: 0,
                                left: ""
                            }))
                    ...
                    value: function () {
                        ...
                        this.$element.on("click", function (i) {
                            if (i.preventDefault(), !0 === e.menuOut) e.menuOut = !1, e.removeMenu();
                                ...
                                e.menuOut = !0, !0 === e.options.showOverlay ? (e.$sidenavOverlay = t('<div id="sidenav-overlay"></div>'), e.$body.append(e.$sidenavOverlay)) : e.showCloseButton();
                                var n = [];
                    ...
                    value: function () {
                        ...
                        this.options.menuWidth !== e && (this.$menu.css("width", this.options.menuWidth), i.css("width", this.options.menuWidth))
                    }
                }, {
                    key: "assignOptions",
                    value: function (e) {
                ...
                y = v.prototype = {
                    ...
                    start: function () {
                        return p && p.start ? y : (p.methods = {}, p.start = !0, p.open = !1, p.type = e.type, e.autofocus = e == c(), e.readOnly = !f.editable, e.id = e.id || p.id, "text" != e.type && (e.type = "text"), y.component = new u(y, f), y.$root = t('<div class="' + m.picker + '" id="' + e.id + '_root" />'), s(y.$root[0], "hidden", !0), y.$holder = t(b()).appendTo(y.$root), x(), f.formatSubmit && function () {
                            ...
                            g.data(l, y).addClass(m.input).val(g.data("value") ? y.get("select", f.format) : e.value), f.editable || g.on("focus." + p.id + " click." + p.id, (t = function (t) {
    ...
    function () {
        ...
        function M(t, e) {
            ...
            e.darktheme && r.addClass("darktheme"), n('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (e.twelvehour ? "3" : "1") + '">' + e.donetext + "</button>").click(n.proxy(this.done, this)).appendTo(this.footer), n('<button type="button" class="btn btn-flat clockpicker-button" tabindex="' + (e.twelvehour ? "4" : "2") + '">' + e.cleartext + "</button>").click(n.proxy(this.clearInput, this)).appendTo(this.footer), this.spanHours.click(n.proxy(this.toggleView, this, "hours")), this.spanMinutes.click(n.proxy(this.toggleView, this, "minutes")), A.on("focus.clockpicker click.clockpicker", m(n.proxy(this.show, this), 300));
            var E, L, R, $, F = n('<div class="clockpicker-tick"></div>');
            if (e.twelvehour)
                for (E = 0; E < 12; E += e.hourstep) L = F.clone(), R = E / 6 * Math.PI, $ = b, L.css("font-size", "140%"), L.css({
                    left: y + Math.sin(R) * $ - w,
                    top: y - Math.cos(R) * $ - w
                }), L.html(0 === E ? 12 : E), p.append(L), L.on(u, z);
            else
                for (E = 0; E < 24; E += e.hourstep) {
                    L = F.clone(), R = E / 6 * Math.PI;
                    var W = E > 0 && E < 13;
                    $ = W ? x : b, L.css({
                        left: y + Math.sin(R) * $ - w,
                        top: y - Math.cos(R) * $ - w
                    }), W && L.css("font-size", "120%"), L.html(0 === E ? "00" : E), p.append(L), L.on(u, z)
                }
            var V = Math.max(e.minutestep, 5);
            for (E = 0; E < 60; E += V)
                for (E = 0; E < 60; E += 5) L = F.clone(), R = E / 30 * Math.PI, L.css({
                    left: y + Math.sin(R) * b - w,
                    top: y - Math.cos(R) * b - w
                }), L.css("font-size", "140%"), L.html(g(E)), M.append(L), L.on(u, z);
                ...
                if (!i || !(f < b - w || f > b + w)) {
                    ...
                    s && l.append(_.canvas), _.setHand(u, p, !i, !0), a.off(d).on(d, function (t) {
                        ...
                        (i || m) && o === u && s === p && _.setHand(o, s), "hours" === _.currentView ? _.toggleView("minutes", C / 2) : e.autoclose && (_.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                            _.done()
                        }, C / 2)), l.prepend(N), clearTimeout(g), _.popover.removeClass("clockpicker-moving"), a.off(d)
                    })
                }
            }
            if (l.on(u, function (t) {
                ...
                var q = f("circle");
                q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), j.appendChild(Y), j.appendChild(X), j.appendChild(q), j.appendChild(B), H.appendChild(j), N.append(H), this.hand = Y, this.bg = X, this.fg = q, this.bearing = B, this.g = j, this.canvas = N
            }
            T(this.options.init)
        }
        ...
        M.DEFAULTS = {
            ...
            if (!this.isShown) {
                ...
                }, 300)), a.on("keyup.clockpicker." + this.id, m(function (t) {
                    27 === t.keyCode && e.hide()
    ...
    function (t, e) {
        ...
        return function (t, e, i, n) {
            ...
            o.extend(r, n);
            var s, l, c, u, d, h, p, f, m, g, v, y, b, x, w, k, C, S, M, T, P, I, A, O, _, D, E, L, R, $, F, W, V, z, N, H, j, B, Y, X, q, U, Q, Z, K, G, J, tt, et, it, nt, ot, at, rt, st, lt = {
                    x: 0,
                    y: 0
                },
                ct = {
                ...
                Rt = null,
                $t = function () {
                    Rt && (o.unbind(document, "mousemove", $t), o.addClass(t, "pswp--has_mouse"), r.mouseUsed = !0, St("mouseUsed")), Rt = setTimeout(function () {
                        Rt = null
                    }, 100)
                },
                Ft = function (t, e) {
                ...
                Zt = {
                    ...
                    setScrollOffset: function (t, e) {
                        pt.x = t, $ = pt.y = e, St("updateScrollOffset", pt)
                    },
                    ...
                    init: function () {
                        if (!s && !l) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), E = t.className, s = !0, F = o.detectFeatures(), _ = F.raf, D = F.caf, I = F.transform, R = F.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                                ...
                                function () {
                                    if (I) {
                                        ...
                                        return y = "translate" + (e ? "3d(" : "("), void(b = F.perspective ? ", 0px)" : ")")
                                    }
                            ...
                            for (F.animationName && F.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < vt.length; i++) a["init" + vt[i]]();
                            e && (a.ui = new e(a, o)).init(), St("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= ze()) && (u = 0), a.currItem = Ve(u), (F.isOldIOSPhone || F.isOldAndroid) && (gt = !1), t.setAttribute("aria-hidden", "false"), r.modal && (gt ? t.style.position = "fixed" : (t.style.position = "absolute", t.style.top = o.getScrollY() + "px")), void 0 === $ && (St("initialLayout"), $ = L = o.getScrollY());
                            var c = "pswp--open ";
                            for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += O ? "pswp--touch" : "pswp--notouch", c += F.animationName ? " pswp--css_animation" : "", c += F.svg ? " pswp--svg" : "", o.addClass(t, c), a.updateSize(), h = -1, mt = null, i = 0; 3 > i; i++) Ot((i + h) * ft.x, k[i].el.style);
                            R || o.bind(a.scrollWrap, f, a), Ct("initialZoomInEnd", function () {
                                a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && t.focus(), o.bind(document, "keydown", a), F.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", $t), o.bind(window, "resize scroll", a), St("bindEvents")
                    ...
                    close: function () {
                        s && (s = !1, l = !0, St("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", $t), F.transform && o.unbind(a.scrollWrap, "click", a), B && o.unbind(window, p, a), St("unbindEvents"), Ne(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function () {
                        St("destroy"), Re && clearTimeout(Re), t.setAttribute("aria-hidden", "true"), t.className = E, x && clearInterval(x), o.unbind(a.scrollWrap, f, a), o.unbind(window, "scroll", a), pe(), Ut(), kt = null
                    },
                    ...
                    updateSize: function (e) {
                        if (!gt && r.modal) {
                            var i = o.getScrollY();
                            if ($ !== i && (t.style.top = i + "px", $ = i), !e && yt.x === window.innerWidth && yt.y === window.innerHeight) return;
                        ...
                        if (dt.x = a.scrollWrap.clientWidth, dt.y = a.scrollWrap.clientHeight, jt(), ft.x = dt.x + Math.round(dt.x * r.spacing), ft.y = dt.y, _t(ft.x * ht), St("beforeResize"), void 0 !== h) {
                            for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Ot((c + h) * ft.x, n.el.style), l = u + c - 1, r.loop && ze() > 2 && (l = wt(l)), (s = Ve(l)) && (w || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Ye(s, dt), Qe(s), At(s));
                            w = !1
                        }
                ...
                Te = function (t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!j || "mousedown" !== t.type) {
                            ...
                            var i = Se(t),
                                n = i.length;
                            Z = null, Ut(), B && 1 !== n || (B = nt = !0, o.bind(window, p, a), N = rt = ot = H = Q = q = Y = X = !1, it = null, St("firstTouchStart", i), Et(ct, ut), lt.x = lt.y = 0, Et(te, i[0]), Et(ee, te), ne.x = ft.x * ht, oe = [{
                                x: te.x,
                                y: te.y
                            }], V = W = Mt(), Ft(g, !0), pe(), fe()), !K && n > 1 && !et && !Q && (v = g, X = !1, K = Y = !0, lt.y = lt.x = 0, Et(ct, ut), Et(Kt, i[0]), Et(Gt, i[1]), be(Kt, Gt, de), ue.x = Math.abs(de.x) - ut.x, ue.y = Math.abs(de.y) - ut.y, G = he(Kt, Gt))
                        }
                    }
                },
                Pe = function (t) {
                ...
                Ae = function (t) {
                    ...
                    var c = -1;
                    if (0 === l && (B = !1, o.unbind(window, p, a), pe(), K ? c = 0 : -1 !== le && (c = Mt() - le)), le = 1 === l ? Mt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || H)
                ...
                De = function (t, e) {
                    ...
                    var d, h = ft.x * ht,
                        p = Math.abs(h - ce.x);
                    return i || h > ce.x == e.lastFlickSpeed.x > 0 ? (d = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, re === u && (i = !1), et = !0, St("mainScrollAnimStart"), Qt("mainScroll", ce.x, h, d, o.easing.cubic.out, _t, function () {
            ...
            xt("Gestures", {
                publicMethods: {
                    initGestures: function () {
                        ...
                        (A = F.pointerEvent) && F.touch && (F.touch = !1), A ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : F.touch ? (t("touch", "start", "move", "end", "cancel"), O = !0) : t("mouse", "down", "move", "up"), p = M + " " + T + " " + P, f = S, A && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = O, m[S] = Te, m[M] = Pe, m[T] = Ae, P && (m[P] = m[T]), F.touch && (f += " mousedown", p += " mousemove mouseup", m.mousedown = m[S], m.mousemove = m[M], m.mouseup = m[T]), O || (r.allowPanToNext = !1)
                    }
                }
            });
            var Re, $e, Fe, We, Ve, ze, Ne = function (e, i, n, s) {
                    var l;
                    Re && clearTimeout(Re), We = !0, Fe = !0, e.initialLayout ? (l = e.initialLayout, e.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(u);
                    var d = n ? r.hideAnimationDuration : r.showAnimationDuration,
                        h = function () {
                            Xt("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Tt(1), i && (i.style.display = "block"), o.addClass(t, "pswp--animated-in"), St("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), We = !1
                        };
                        ...
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (g = l.w / e.w, ut.x = l.x, ut.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, It()), qt("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                            ...
                            if (St("initialZoom" + (n ? "Out" : "In")), n) {
                                var a = l.w / e.w,
                                    ...
                                    u = at,
                                    p = function (e) {
                                        1 === e ? (g = a, ut.x = l.x, ut.y = l.y - $) : (g = (a - c) * e + c, ut.x = (l.x - r.x) * e + r.x, ut.y = (l.y - $ - r.y) * e + r.y), It(), s ? t.style.opacity = 1 - e : Tt(u - e * u)
                                    };
            ...
            xt("Controller", {
                publicMethods: {
                    ...
                    initController: function () {
                        o.extend(r, Be, !0), a.items = $e = i, Ve = a.getItemAt, ze = r.getNumItemsFn, r.loop, ze() < 3 && (r.loop = !1), Ct("beforeChange", function (t) {
                            var e, i = r.preload,
                                n = null === t || t >= 0,
                                o = Math.min(i[0], ze()),
                                s = Math.min(i[1], ze());
                            ...
                            for (var t, e = 0; e < $e.length; e++)(t = $e[e]).container && (t.container = null), t.placeholder && (t.placeholder = null), t.img && (t.img = null), t.preloader && (t.preloader = null), t.loadError && (t.loaded = t.loadError = !1);
                            je = null
                        })
                    },
                    ...
                    setContent: function (t, e) {
                        ...
                        if (l) {
                            ...
                            if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ue(l), Ye(l, dt), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Qe(l, n), Xe(0, l, c, n));
                                ...
                                if (l.loadComplete = function (i) {
                                        if (s) {
                                            if (t && t.index === e) {
                                                ...
                                                i.imageAppended ? !We && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : F.transform && (et || We) ? je.push({
                                                    item: i,
                                                    baseDiv: c,
                                                    img: i.img,
                                                    index: e,
                                ...
                                l.loading || qe(l), a.allowProgressiveImg() && (!Fe && F.transform ? je.push({
                                    item: l,
                                    baseDiv: c,
                                    img: l.img,
                                    index: e,
                            ...
                            Fe || e !== u ? At(l) : (tt = c.style, Ne(l, n || l.img)), t.el.innerHTML = "", t.el.appendChild(c)
                        } else t.el.innerHTML = ""
                    },
            ...
            x.init = function () {
                e.extend(t.options, S, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), d = t.listen,
                    function () {
                        ...
                        C || O(), y && clearInterval(y), e.unbind(document, "mouseout", $), e.unbind(document, "mousemove", R), e.unbind(n, "pswpTap click", M), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
                    }), d("destroy", function () {
                    ...
                    function () {
                        ...
                        e.bind(document, "mousemove", R), e.bind(document, "mouseout", $), y = setInterval(function () {
                            2 == ++L && x.setIdle(!0)
                        }, g.timeToIdle / 2)
                    }), g.fullscreenEl && !e.features.isOldAndroid && (i || (i = x.getFullscreenAPI()), i ? (e.bind(document, i.eventK, x.updateFullscreen), x.updateFullscreen(), e.addClass(t.template, "pswp--supports-fs")) : e.removeClass(t.template, "pswp--supports-fs")), g.preloaderEl && (F(!0), d("beforeChange", function () {
